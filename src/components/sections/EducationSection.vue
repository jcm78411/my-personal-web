    ...
    <div class="text-center">
      ...
      <div class="flex flex-wrap justify-center gap-5 mt-16 text-left">
        <div class="w-80 flex flex-col items-start border border-gray-200 p-5 rounded-lg bg-white">
          ...
          <p class="text-sm mt-3 text-gray-500">PrebuiltUI strikes the perfect balance between flexibility, simplicity
            and visual consistency.</p>
          <div class="flex items-center gap-3 mt-4">
            <img class="h-12 w12 rounded-full"
        ...
        <div class="w-80 flex flex-col items-start border border-gray-200 p-5 rounded-lg bg-white">
          ...
          <p class="text-sm mt-3 text-gray-500">Clean layouts, responsive design and easy integration make PrebuiltUI
            incredibly valuable.</p>
          <div class="flex items-center gap-3 mt-4">
            <img class="h-12 rounded-full" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=100"
              alt="userImage2">
            <div>
        ...
        <div class="w-80 flex flex-col items-start border border-gray-200 p-5 rounded-lg bg-white">
          ...
          <p class="text-sm mt-3 text-gray-500">This library helped me ship client projects faster with better and
            beautiful design experience.</p>
          <div class="flex items-center gap-3 mt-4">
